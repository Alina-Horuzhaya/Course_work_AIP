...
{
    public partial class Detained_UK : Form
    {
        ...
        private void LoadData()
        {
            ...
            {
                conn.Open();
                string query = "SELECT * FROM detained_uk_rf ORDER BY id";
        ...
        {
            return value.Split(' ')[0]; //разбивает строку на подстроки 
        }
        ...
        private void button_Export_Excele_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialoge.FileName = "Отчёт по УК";
